...
?>
<div class="jenis-diklat-view">

    <h1>Detail Jenis Diklat</h1>
    ...
    <p>
        ...
        <?= Html::a('<i class="glyphicon glyphicon-list"></i> Daftar Jenis Diklat', ['index', 'id' => $model->id], ['class' => 'btn btn-warning']) ?>
    </p>
</div>
